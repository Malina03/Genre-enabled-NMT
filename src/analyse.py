...
def main():
    ...
    print("Average document length in test set Icelandic: {} and std {} and median {}".format(data[data['set']=='test']['tr_doc_length'].mean(), data[data['set']=='test']['tr_doc_length'].std(), data[data['set']=='test']['tr_doc_length'].median()))
